...
Set-AzVMCustomScriptExtension -ResourceGroupName $RGName -Location $Location -VMName  $VMNAME -FileUri "https://raw.githubusercontent.com/Help4InfoCR430/CR430-GROUPE-N/main/remote.ps1" -Run 'remote.ps1' -Name EnableWINRMHTTPS
